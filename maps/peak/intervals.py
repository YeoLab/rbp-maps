        ...
        for line in f:
            ...
            if (exstr == '+'):
                ...
                if event_type == 'a5ss':
                    ...
                    upstream_region_start = max(int(upstop) + 1, int(
                        exstart) - intron_overhang)  # (end of upstream exon) OR (start - 500)

                upstream_region_stop = min(int(exstop), int(
                    exstart) + exon_overhang)  # (end of skipped exon) OR (start of skipped exon + 50)
                ...
                dnex_region_start = max(int(exstop) + 1, int(
                    dnstart) - intron_overhang)  # end of skipped exon OR start of downstream exon - 500
                dnex_region_stop = min(int(dnstop), int(
                    dnstart) + exon_overhang)  # end of downstream exon OR start of downstream exon + 50
                ...
                downstream_region_start = max(int(exstart), int(
                    exstop) - exon_overhang)  # beginning of skipped exon OR end of skipped exon - 50
                downstream_region_stop = min(int(dnstart) - 1, int(
                    exstop) + intron_overhang)  # start of downstream exon OR end of skipped exon + 500
                ...
                upex_region_start = max(int(upstart), int(
                    upstop) - exon_overhang)  # start of upstream exon OR end of upstream exon - 50
                upex_region_stop = min(int(exstart) - 1, int(
                    upstop) + intron_overhang)  # start of skipped exon OR end of upstream exon + 500
