...
class ClipWithInput(Map):
    ...
    def create_a3ss_matrices(self, label=""):
        ...
        self.ip_raw_density['feature'].to_csv(
            "{}.ip.{}.{}.a3ss.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.input_raw_density['feature'].to_csv(
            "{}.input.{}.{}.a3ss.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.maptype = 'a3ss'
    ...
    def create_a5ss_matrices(self, label=""):
        ...
        self.ip_raw_density['feature'].to_csv(
            "{}.ip.{}.{}.a5ss.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.input_raw_density['feature'].to_csv(
            "{}.input.{}.{}.a5ss.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.maptype = 'a5ss'
    ...
    def create_mxe_matrices(self, label=""):
        ...
        self.logger.info("Start creating the MXE Matrix - {}".format(self.name))
        self.ip_raw_density['feature'].to_csv(
            "{}.ip.{}.{}.mxe.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.input_raw_density['feature'].to_csv(
            "{}.input.{}.{}.mxe.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.maptype = 'mxe'
    ...
    def create_se_matrices(self, label=""):
        ...
        self.ip_raw_density['feature'].to_csv(
            "{}.ip.{}.{}.se.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.input_raw_density['feature'].to_csv(
            "{}.input.{}.{}.se.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.maptype = 'se'
    ...
    def create_ri_matrices(self, label=""):
        ...
        self.logger.info("Finished creating the SE Matrix - {}".format(self.name))
        self.ip_raw_density['feature'].to_csv(
            "{}.ip.{}.{}.ri.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.input_raw_density['feature'].to_csv(
            "{}.input.{}.{}.ri.raw_density_matrix.csv".format(self.output_base, label, 'feature'))
        self.maptype = 'ri'
